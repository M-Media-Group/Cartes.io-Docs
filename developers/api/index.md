...
Note: you must pass the `Accept: application/json` header for the API to work as expected. Make sure to also pass the `Content-Type: application/json` when making requests with a body.
